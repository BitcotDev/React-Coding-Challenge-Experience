                        ...
                        <li class="list-items user_peofile">
                            <div class="media align-items-center dropdown-toggle " data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right animate slideIn account_info" aria-labelledby="navbarDropdown">
                                    ...
                                    <div>
                                    <NavLink to="/login" onClick={(event)=> Auth.cdispatch({type:"logout",value:false}) }>Logout</NavLink>
                                    </div>
                                </div>
                            </div>
                        </li>
